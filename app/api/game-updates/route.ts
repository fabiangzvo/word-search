...
declare global {
  var gameStates: Record<
    string,
    {
      playerScores: Array<{ username: string; score: number }>
      foundWords: string[]
      foundCells: number[][]
      activePlayers: Array<{ username: string; lastActive: number }>
    }
  >
  var gameConnections: Record<string, Array<(data: any) => void>>
}
